...
<body>
	...
	<section class="section-steps" id="work">
		...
		<div class="row">
			<div class="col span-1-of-2 steps-box">
				<img src="resources/img/app-iPhone.png" alt="iphone look" class="app-screen js-wp-2">
			</div>
			<div class="col span-1-of-2 steps-box">
	...
	<section class="section-cities" id="city">
		...
		<div class="row js-wp-3">
			<div class="col span-1-of-4 box">
				<img src="resources/img/lisbon-3.jpg" alt="city 1">
				<h3>Lisbon</h3>
			...
			<div class="col span-1-of-4 box">
				<img src="resources/img/san-francisco.jpg" alt="city 2">
				<h3>San Francisco</h3>
				<div class="city-features">
			...
			<div class="col span-1-of-4 box">
				<img src="resources/img/berlin.jpg" alt="city 1">
				<h3>Berlin</h3>
				<div class="city-features">
			...
			<div class="col span-1-of-4 box">
				<img src="resources/img/london.jpg" alt="city 1">
				<h3>London</h3>
				<div class="city-features">
		...
		<div class="row">
			<div class="col span-1-of-3">
				<blockquote>
					...
					<cite><img src="resources/img/customer-1.jpg" alt="user1">Alberto Duncan</cite>
				</blockquote>
			</div>
			<div class="col span-1-of-3">
				<blockquote>
					...
					<cite><img src="resources/img/customer-2.jpg" alt="user1">Joana Silva</cite>
				</blockquote>
			</div>
			<div class="col span-1-of-3">
				<blockquote>
					I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
					<cite><img src="resources/img/customer-3.jpg" alt="user1">Milton Chapman</cite>
				</blockquote>
			</div>
		</div>
	</section>
	<section class="section-plan js-section-plan" id="sign">
		<div class="row">
			...
			<div class="col span-1-of-3">
				<div class="plan-box js-wp-4">
					...
					<div>
						<ul>
							<li>
								<i class="ion-ios-checkmark-outline icon-small"></i>1 meal every day
							</li>
							<li>
								<i class="ion-ios-checkmark-outline icon-small"></i>Order 24/7
							</li>
							<li>
								<i class="ion-ios-checkmark-outline icon-small icon-small"></i>Access to newest creations
							</li>
							<li>
								<i class="ion-ios-checkmark-outline icon-small"></i>Free delivery
							</li>
						</ul>
					</div>
					<div>
			...
			<div class="col span-1-of-3">
				<div class="plan-box">
					...
					<div>
						<ul>
							<li>
								<i class="ion-ios-checkmark-outline icon-small"></i>1 meal 10 days/month
							</li>
							<li>
								<i class="ion-ios-checkmark-outline icon-small"></i>Order 24/7
							</li>
							<li>
								<i class="ion-ios-checkmark-outline icon-small"></i>Access to newest creations
							</li>
							<li>
								<i class="ion-ios-checkmark-outline icon-small"></i>Free delivery
							</li>
			...
			<div class="col span-1-of-3">
				<div class="plan-box">
					...
					<div>
						<ul>
							<li>
								<i class="ion-ios-checkmark-outline icon-small"></i>1 meal
							</li>
							<li>
								<i class="ion-ios-checkmark-outline icon-small"></i>Order from 8 am to 12 pm
							</li>
							<li>
	...
	<section class="section-form">
		...
		<div class="row">
			<form method="post" action="mailer.php" class="contact-form">
				...
				<div class="row">
					<div class="col span-1-of-3">
						<label for="msg">Drop us a line</label>
					</div>
					<div class="col span-2-of-3">
